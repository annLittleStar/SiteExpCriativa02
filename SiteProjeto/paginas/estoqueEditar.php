            ...
            <div class="w3-code cssHigh notranslate">
				...
				?>				
								...
								<form class="w3-container" action="estoqueEditarBD.php" method="post" onsubmit="return check(this.form)">
									...
									<input class="w3-input w3-border w3-light-grey" name="Nome" type="text" pattern="[a-zA-Z0-9\u00C0-\u00FF ]{1,100}$"
										   title="Nome do Produto." value="<?php echo $row['nomeProd']; ?>" required></p>
									<label class="w3-text-deep-purple"><b>Marca</b></label>
									<input class="w3-input w3-border w3-light-grey" name="Marca" type="text" pattern="[a-zA-Z0-9\u00C0-\u00FF ]{1,100}$"
										   title="Nome do Produto." value="<?php echo $row['marcaProd']; ?>" required></p>
									<p>
									<label class="w3-text-deep-purple"><b>Valor de Venda</b></label>
									<input class="w3-input w3-border w3-light-grey" name="Venda" type="text" pattern="[0-9]+(.[0-9][0-9]?)?"
