    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        ...
        <p class="w3-large">
            <div class="w3-code cssHigh notranslate">
				...
				$sql = "SELECT id, nome, carro, disponibilidade FROM pneu WHERE id = $id";
				...
				?>				
								...
								<div class="w3-container w3-theme">
									<h2>Melhores Pneus para este carro = [<?php echo $row['id']; ?>]</h2>
								</div>
								<form class="w3-container" action="estoqueListarPneuBD.php" method="post" onsubmit="return check(this.form)">
                                    ...
                                    <input class="w3-input w3-border w3-light-grey" name="Disponibilidade" type="text" pattern="[a-zA-Z0-9\u00C0-\u00FF ]{4,100}$"
                                           title="Disponibilidade do pneu entre 4 e 100 letras." value="<?php echo $row['nome']; ?>" required readonly></p>
