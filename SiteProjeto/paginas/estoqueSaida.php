							...
							<form class="w3-container" action="estoqueSaidaBD.php" method="post" onsubmit="return check(this.form)">
								...
								<p>
									...
									<p>
										...
										title="Tipo do Produto." value="<?php echo $row['tipoProd']; ?>" required readonly></p>
										<p>
											...
											title="Quantidade de itens em estoque." value="<?php echo $row['quantidadeProd']; ?>" required readonly></p>
											<p>
