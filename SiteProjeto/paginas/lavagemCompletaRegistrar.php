        ...
        <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
            ...
            <p class="w3-large">
                <div class="w3-code cssHigh notranslate">
                    ...
                    (categoria = 'Dono' OR categoria = 'Lavador')";
                    ?>
                    ...
                    <div class="w3-responsive w3-card-4">
                        ...
                        <form class="w3-container" action="lavagemCompletaBD.php" method="post" onsubmit="return check(this.form)">
                          ...
                          <p>
                            ...
                            <input class="w3-input w3-border w3-light-grey" name="dataHorario" type="text" value="<?php $dataB = date("Y/m/d H:i:s", time()); echo "$dataB" ?>" title="Data e hora do registro." required readonly></p>
                            <p>
                                <label class="w3-text-deep-purple"><b>Valor em reais</b></label>
                                <input class="w3-input w3-border w3-light-grey" name="valorLavagem" type="text"  title="Tipo de Lavagem: Preço da Lavagem Completa." value="30.00" pattern="[0-9]+(.[0-9][0-9]?)?" required readonly></p>
                                <p>
