                    ...
                    <div class="w3-responsive w3-card-4">
                        ...
                        <form class="w3-container" action="lavagemDuchaBD.php" method="post" onsubmit="return check(this.form)">
                          ...
                          <p>
                            ...
                            <input class="w3-input w3-border w3-light-grey" name="dataHorario" type="text" value="<?php $dataC = date("Y/m/d H:i:s", time()); echo "$dataC" ?>" title="Data e hora do registro." required readonly></p>
                            <p>
