                ...
                <p>
                    <div class="w3-code cssHigh notranslate">
                        ...
                        if ($result = mysqli_query($conn, $sql)) {
                            ...
                            <input type="text" name="pesquisar" style="width:90%" placeholder="Digite o Nome, CPF ou Cargo do Funcionário que deseja encontrar">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                if (isset($_GET['pesquisar']) && $_GET['pesquisar']!==''){
                                    ...
                                    $result_p = "SELECT * FROM funcionario WHERE ativo='Sim' AND
                                    (nome LIKE '%$pesquisar%' OR cpf LIKE '$pesquisar' OR categoria LIKE '$pesquisar')
