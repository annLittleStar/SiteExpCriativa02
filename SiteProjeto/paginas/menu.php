...
<div class="w3-top">
	...
	<div class="w3-row w3-white w3-padding">
		...
		<div class="w3-half w3-margin-top w3-wide w3-hide-medium w3-hide-small">
			<div class="w3-right"><a href="../entrar.php"><img src="../imagens/sair.png" width="25" height="25" href="../entrar.php"></a></div>
		</div>
	</div>
...
<div class="w3-sidebar w3-bar-block w3-collapse w3-animate-left" style="z-index:3;width:270px" id="mySidebar">
	...
	<div id="menuFuncionario" class="myMenu">
		...
		<a class="w3-bar-item w3-button" href="listarFuncionario.php">Relação de Funcionários</a>
		<a class="w3-bar-item w3-button" href="contratarFuncionario.php">Contratação</a>
		<a class="w3-bar-item w3-button" href="funcionarioDesativado.php">Funcionários Desativados</a>
	</div>
