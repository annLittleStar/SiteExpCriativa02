...
<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        <h1 class="w3-xxlarge">Ordem de Servico</h1>
            ...
            <div class="w3-code cssHigh notranslate">
                ...
                <div class="w3-responsive w3-card-4">
                    <div class="w3-container w3-theme">
                        <h2>Informe os dados da Ordem de Servico</h2>
                    </div>
                    <form class="w3-container" method="post" onsubmit="return check(this.form)">
                        ...
                        <input class="w3-input w3-border w3-light-grey" name="marca" type="text" title="Marca do Produto." required></p>
                            ...
                            <input type="button" value="Venda" class="w3-btn w3-green" onclick="window.location.href='vendasRegistrar.php'">
                            <input type="button" value="Lavagem S" class="w3-btn w3-green" >
                            <input type="button" value="Lavagem C" class="w3-btn w3-green" >
