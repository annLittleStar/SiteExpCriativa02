...
<body onload="w3_show_nav('menuFuncionario')">
	...
	<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
		...
		<div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
			<h1 class="w3-xxlarge">Reativar Funcionário</h1>
		...
		// Faz Update na Base de Dados
					if($tel != null && $nome != null){
						$sql = "UPDATE funcionario SET nome='$nome', telefone='$tel', categoria='$cargo', ativo = 'Sim' WHERE id=$id";
					}else{
						$sql = "UPDATE funcionario SET ativo = 'Sim' WHERE id=$id";
					}

					echo "<div class='w3-responsive w3-card-4'>";

					if ($result = mysqli_query($conn, $sql) && $tel != null || $nome != null) {
						echo "Funcionário reativado no sistema!";
					}else if ($result = mysqli_query($conn, $sql) && $tel == null || $nome == null) {
						echo "Não foi possível reativar o funcionário";
					}else {
