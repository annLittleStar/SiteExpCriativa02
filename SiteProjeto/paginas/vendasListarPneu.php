...
<body onload="w3_show_nav('menuServicos')">
    ...
    <div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
        ...
        <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
            <h1 class="w3-xxlarge">Pneus Disponíveis</h1>
            ...
            <p class="w3-large">
                <p>
                    <div class="w3-code cssHigh notranslate">
                        ...
                        $sql = "SELECT idProd, nomeProd, marcaProd, quantidadeProd, tipoProd, precoProd FROM produto WHERE tipoProd='Pneu' AND quantidadeProd>0";
