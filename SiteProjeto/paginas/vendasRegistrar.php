                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <form class="w3-container" action="vendasRegistrarBD.php" method="post" onsubmit="return check(this.form)">
                              ...
                              <p>
                                ...
                                <input class="w3-input w3-border w3-light-grey" name="data" type="text" value="<?php $dataA = date("Y/m/d H:i:s", time()); echo "$dataA" ?>" title="Data e hora do registro." required readonly=""></p>
                                <p>
